...
<?php $this->beginPage() ?>
<!DOCTYPE html>
<html lang="<?= Yii::$app->language ?>" class="h-100 no-js" lang="zxx">

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Decor - интернет магазин</title>
...
<?php $this->beginBody() ?>
    ...
    <!-- header area start -->
    <header id="header">
        <div id="header-sticky" class="header-area header-transparent-2 header-sticky header-sticky-white fixed-top">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-6 col-sm-4 col-4">
                            <div class="header-left p-rel d-flex align-items-center">
                                <div class="logo pr-55 d-inline-block">
                                    <a href="http://project/"><strong>DECOR</strong></a>
                                </div>
                                <div class="main-menu main-menu-3">
                                    <nav id="mobile-menu">
                                        <ul>
                                            <li>
                                                <a href="http://project/">Главная</a>
                                            </li>
                                            <li class="static">
                                                <a href="/shop/catalog">Магазин <!--<i class="icon-arrow-down"></i>--></a>
                                                <!-- <ul class="mega-menu mega-menu-4-col">
                                                   <li class="has-dropdown">
                                                    <?= Html::a('Мебель', ['/shop/catalog', 'category' => 'Мебель']) ?>
                                                       <ul class="has-dropdown">
                                                           <li><?= Html::a('Диваны', ['/shop/catalog', 'type' => 'Диваны']) ?></li>
                                                           <li><a href="shop.html">Кресла</a></li>
                                                       </ul>
                                                   </li>
                                                   <li class="has-dropdown">
                                                       <a href="shop.html">Текстиль</a>
                                                       <ul class="has-dropdown">
                                                           <li><a href="shop.html">Ковры</a></li>
                                                           <li><a href="shop.html">Декоративные подушки</a></li>
                                                       </ul>
                                                   </li>
                                                   <li class="has-dropdown">
                                                       <a href="shop.html">Декор</a>
                                                       <ul class="has-dropdown">
                                                           <li><a href="shop-right-sidebar.html">Свечи</a></li>
                                                           <li><a href="shop.html">Зеркала</a></li>
                                                       </ul>
                                                   </li>
                                                   <li class="has-dropdown">
                                                       <a href="shop.html">Свет</a>
                                                       <ul class="has-dropdown">
                                                           <li><a href="shop.html">Настольные светильнки</a></li>
                                                           <li><a href="shop.html">Напольные светильнки</a></li>
                                                       </ul>
                                                   </li>
                                                </ul> -->
                                            </li>
                                            <li>
                                                <a href="/shop/info/about">О нас</a>
                                            </li>
                                            <li><a href="/shop/info/contact">Контакты</a></li>
                                            <?php
                                            ...
                                            ?>
                                            <li>
                                            <a href="/shop/order">Личный кабинет</a>
                                            </li>        
                                            <?php
                                            endif;
                                            ?>
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-8 col-8">
                            ...
                            <div class="header-right-wrapper d-flex align-items-center justify-content-end">
                                ...
                                <div class="header-right header-right-3 d-flex align-items-center justify-content-end">

                                    <div class="header-icon header-icon-3 d-inline-block ml-30">
                    
                                        <button type="button" id="cart-link" href="" class="nav-link">

                                        <?= !empty($cart['count']) ? '<i class="fal fa-shopping-cart"></i><span>' . $cart['count'] . '</span></button>' : '<i class="fal fa-shopping-cart"></i>' ?>
...
echo 'Добавлено доступное количество товара';
...
<footer id="footer" class="mt-auto footer-area footer-3 black-bg">
        <div class="copyright-area">
            <div class="copyright-text copyright-text-2 center-text">
                <div class="container">
                    <p><a href="http://project/"><strong>DECOR</strong>-интернет-магазин</a> <br> Учебный проект</p>
